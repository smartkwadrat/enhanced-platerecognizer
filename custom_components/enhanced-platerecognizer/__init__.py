...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Inicjalizacja PlateManager jeśli potrzeba
    ...
    # Inicjalizacja GlobalRecognitionManager jeśli potrzeba
    ...
    # --- Rejestracja usług (raz na integrację) ---
...
async def _remove_plate_management_entities(hass):
    """Usuwa encje zarządzania tablicami po wyładowaniu ostatniego wpisu."""
    to_remove = [
        "input_text.add_new_plate",
        "input_text.add_plate_owner",
